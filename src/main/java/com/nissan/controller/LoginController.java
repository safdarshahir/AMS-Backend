...
public class LoginController {
	...
	public ResponseEntity<JwtResponse> createAuthenticationToken(@RequestBody User authenticationRequest) throws Exception {
		...
		// taking username and usertypeId
		String userName = user.getUserName();
		Integer userTypeNo = user.getUserType().getUserTypeNo();
		
		return new ResponseEntity<JwtResponse>(new JwtResponse(token, userName, userTypeNo),HttpStatus.OK);
	}
